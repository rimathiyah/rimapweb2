...
<html lang="en">
  ...
  <body>
   ...
   <!--  Contact -->
     <section class="ds-banner contact section-padding pt-0" id="contact">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-12">
            <form action="#" method="get" class="contact-form webform"  role="form">
                ...
                <button type="submit" class="ds-button" id="submit-button" name="submit">Send</button>
            </form>
          </div>

            <div class="mx-auto col-lg-4 col-md-6 col-12">
                <h3 class="my-4 pt-4 pt-lg-0">Stay in touch!</h3>

                <p class="mb-1">Ready to talk?</p>
                ...
                <ul class="social-links mt-2">
                    <li><a href="https://www.instagram.com/rimathiyah/" class="ds-button">Meet Me on Instagram</a></li>
                </ul>
